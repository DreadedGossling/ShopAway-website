...
//   const validate = () => {
//     let formErrors = {};
//     if (!formData.username) formErrors.username = 'Email is required';
...
//             setAlert(
//               <div style={{
//                 backgroundColor: '#f2e355', padding: '10px', paddingLeft: '30px',
//                 marginTop: '4px', width: '175px', display: 'flex', borderRadius: '8px',
//                 textAlign: 'center'
//               }}>
//                 <IoWarningOutline style={{ fontSize: '20px', marginRight: '4px', color: 'black', fontWeight: 'bolder' }} />
//                 <span style={{ fontWeight: 'bold', marginTop: '3px' }}>Login Successful</span>
//               </div>
//             )
...
//           }}>
//             <IoWarningOutline style={{ fontSize: '20px', marginRight: '4px', color: 'black', fontWeight: 'bolder' }} />
//             <span style={{ fontWeight: 'bold', marginTop: '3px' }}>Invalid Credentials</span>
//           </div>
//         )
//         setTimeout(() => {
//           setAlert(null)
